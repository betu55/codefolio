    ...
    <div className="relative" ref={pickerRef}>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/35 px-4 py-6">
          <div className="w-full max-w-md rounded-2xl border border-brand-border_dark bg-brand-light_bg p-4 shadow-xl dark:border-brand-border_light dark:bg-brand-dark_bg ">
            <div className="mb-4 flex items-center justify-between">
              <Button
                ...
                className="inline-flex h-9 w-9 items-center justify-center text-center rounded-lg border border-brand-border_dark dark:border-brand-border_light"
            ...
            <div className="grid grid-cols-7 gap-1">
              {monthCells.map((day, index) => {
                if (!day) {
                  return (
                    <div key={`empty-${index}`} className="h-11 rounded-xl" />
                  );
                }
